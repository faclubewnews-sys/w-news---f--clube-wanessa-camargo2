...
export const ResetPasswordModal: React.FC<ResetPasswordModalProps> = ({ user, onReset, onCancel }) => {
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-brand-bg-light dark:bg-dark-bg-secondary rounded-2xl shadow-2xl p-8 w-full max-w-md animate-fade-in">
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-brand-text dark:text-dark-accent">Definir Nova Senha</h2>
                    <p className="text-sm text-brand-text/70 dark:text-dark-text-soft mt-2">
                        Olá, {user.name}. Crie sua nova senha de acesso.
                    </p>
                </div>
